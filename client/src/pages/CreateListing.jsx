        ...
        <form className="flex flex-col sm:flex-row gap-4">
            <div className='flex flex-col gap-4 flex-1'>
                ...
                <input type="text" placeholder='Address' className='border p-3 rounded-lg' id='address' required />
                 <div className=" flex gap-6 flex-wrap">
                    ...
                    <div className="flex gap-2"><input type="checkbox" id="offer" className="w-5"/><span>Offer</span></div>    
                </div> 
            ...
            <div className="flex flex-col flex-1 gap-4">
                ...
                <div className='flex gap-4' >
                    ...
                    <button type="button" disabled ={uploading} onClick ={handleImageSubmit}className="p-3 text-green-700 border border-green-700 uppercase hover:shadow-lg disabled:opacity:80">{uploading ? 'uploading...' : 'Upload'}</button>
